...
export const DRILLS = [
  ...
  { key: 'T',       label: SHAPES.T.label,     emoji: SHAPES.T.emoji,     cue: SHAPES.T.cue,
    hint: 'Arms straight out, like an aeroplane.', shape: 'T' },
  { key: 'Y',       label: SHAPES.Y.label,     emoji: SHAPES.Y.emoji,     cue: SHAPES.Y.cue,
    hint: 'Both arms up high and wide.', shape: 'Y' },
